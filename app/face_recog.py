...
path = "/home/pi/Domotics/app/carasConocidas/"
...
def run(path):
    ...
    os.system ("fswebcam --no-banner ~/Domotics/image.jpg")
    frame = cv2.imread("/home/pi/Domotics/image.jpg")
...
#        cv2.putText(frame, name, (left + 6, bottom - 6), font, 1.0, (255, 255, 255), 1)
    ...
    cv2.imwrite("/home/pi/Domotics/app/static/detection/FotoPuerta.jpg", frame)
